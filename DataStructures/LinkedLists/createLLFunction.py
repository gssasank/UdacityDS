...
def create_linked_list_better(input_list):  # Complexity is O(n) as it constantly refers to the tail which saves time
    # in traversing the entire LL, every single time
